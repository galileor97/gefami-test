...
"[project]/app/(pages)/section2/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroui$2f$table$2f$dist$2f$chunk$2d$LSJ2YEQL$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__table_default__as__Table$3e$__ = __turbopack_context__.i("[project]/node_modules/@heroui/table/dist/chunk-LSJ2YEQL.mjs [app-client] (ecmascript) <export table_default as Table>");
...
function Section2() {
    _s();
    const { isOpen, onOpen, onClose, onOpenChange } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$heroui$2f$use$2d$disclosure$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDisclosure"])();
    ...
    const { data, isLoading, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "Section2.useQuery": async ()=>{
                const response = await fetch('https://jsonplaceholder.typicode.com/posts?_limit=10');
                const posts = await response.json();
                return posts.map({
                    "Section2.useQuery": (post)=>({
                            id: post.id,
                            title: post.title,
                            body: post.body
                        })
    ...
    const deleteMutation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useMutation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMutation"])({
        mutationFn: {
            "Section2.useMutation[deleteMutation]": async (postId)=>{
        ...
        }["Section2.useMutation[deleteMutation]"],
        onSuccess: {
            "Section2.useMutation[deleteMutation]": (data, postId)=>{
                //  optimistic update 
                queryClient.setQueryData([
                    'products'
                ], {
                    "Section2.useMutation[deleteMutation]": (oldData)=>{
                        return oldData?.filter({
                            "Section2.useMutation[deleteMutation]": (post)=>post.id !== postId
                        }["Section2.useMutation[deleteMutation]"]) || [];
                    }
                }["Section2.useMutation[deleteMutation]"]);
                onClose();
        ...
        onError: {
            "Section2.useMutation[deleteMutation]": (error)=>{
    ...
    if (isLoading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        fileName: "[project]/app/(pages)/section2/page.tsx",
        lineNumber: 71,
        columnNumber: 27
    }, this);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "p-10 bg-gray-100 h-dvh",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: "text-sm text-gray-500",
                children: "Question 3-6: API Request, Table, Delete & Key Removal"
            }, void 0, false, {
                fileName: "[project]/app/(pages)/section2/page.tsx",
                lineNumber: 76,
                columnNumber: 10
...
_s(Section2, "7zQ52tySGEv9Fa91Iuy3c60FwWk=", false, function() {
    return [
...
//# sourceMappingURL=app_%28pages%29_section2_page_tsx_f61e6f40._.js.map